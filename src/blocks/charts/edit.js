		...
		<>
			<InspectorControls>
				...
				>
					...
					/>
					<ToggleControl
						label={ __( 'Affichage inline', 'dcx-benchmark-luxe' ) }
						help={
							insightMode === 'inline'
								? __(
										"L'insight est affiché directement dans le bloc.",
										'dcx-benchmark-luxe'
								  )
								: __(
										"L'insight s'ouvre dans une modale.",
										'dcx-benchmark-luxe'
								  )
						}
						checked={ insightMode === 'inline' }
						onChange={ ( value ) =>
							setAttributes( {
								insightMode: value ? 'inline' : 'modal',
							} )
						}
					/>
				</PanelBody>
				...
				>
					...
					<TextControl
						...
						value={ xMax }
						onChange={ ( value ) =>
							setAttributes( { xMax: Number( value ) || 100 } )
						}
					/>
					{ items.map( ( item, index ) => (
						...
						>
							...
							/>
							<TextControl
								label={ __( 'Valeur', 'dcx-benchmark-luxe' ) }
								type="number"
								min={ 0 }
								max={ 100 }
								value={ item.value }
			...
			<div { ...blockProps }>
				...
				<div className="dcx-bar-chart__legend">
					{ items.map( ( item, index ) => (
						<span
							key={ index }
							className="dcx-bar-chart__legend-item"
						>
							<span
				...
				{ insightMode === 'inline' ? (
					<div className="dcx-bar-chart__insight-inline">
						<RichText
							tagName="p"
							className="dcx-bar-chart__insight-inline-title"
							allowedFormats={ [] }
							value={ insightText }
							onChange={ ( value ) =>
						...
						<RichText
							tagName="div"
							className="dcx-bar-chart__insight-inline-body"
							allowedFormats={ [ 'core/bold', 'core/italic' ] }
							value={ modalBody }
							onChange={ ( value ) =>
								setAttributes( { modalBody: value } )
							}
							placeholder={ __(
